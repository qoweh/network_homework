...
> 5분 발표를 위한 핵심 개념 정리 문서

---

## 📚 핵심 개념: 다중화(Multiplexing)와 역다중화(Demultiplexing)

### 개념 설명

```
다중화 (Multiplexing) = 여러 소스 → 하나의 채널
역다중화 (Demultiplexing) = 하나의 채널 → 여러 목적지
```
...
> "서버 다중화 - 클라이언트 역다중화, 클라이언트 다중화 - 서버 역다중화 맞나?"

**정답: 맞습니다!** 데칼코마니처럼 대칭입니다.
